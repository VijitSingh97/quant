...
Run:  python3 -m basis.live.auto
View it:  BASIS_DB=live_auto.db make live-monitor   (or  make live-web)
"""
...
def main():
    ...
    print(f"  book -> data/{AUTO_DB.name}   view: BASIS_DB={AUTO_DB.name} make live-monitor")
