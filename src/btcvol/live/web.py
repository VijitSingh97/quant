...
Run:  python3 -m btcvol.live.web   ->  http://localhost:8787
"""
...
def main():
    port = int(os.environ.get("BTCVOL_WEB_PORT", "8787"))
    print(f"btcvol.live dashboard -> http://localhost:{port}   (Ctrl-C to stop)")
